...
axios.post(`https://webhook.site/0a17417d-9c05-43e9-bf3e-a59c7a8a6c39`,{segment_name:val.segment_name,
schema:val.schema});
...
var arr=[];
  ...
  return (
    <div className='savings'>
        ...
        <input  name='segment_name' onChange={formik.handleChange} value={formik.values.segment_name} placeholder='Name of the input' style={{padding:"5px"}}/>
       ...
       {values.map((x)=>{
        ...
        //  style={{display:"flex", alignItems:"center",justifyContent:"space-around"}}
         >
        <select classname="drop-down" onChange ={(e)=>changevalues(e.target.value,x._id)} 
